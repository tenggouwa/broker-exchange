...
HTML5StockChartAPI.prototype.setInd = function(name) {
    if(name=='ma'||name=='MA'||name=='main:'){
        this.write('ind','main:ma|main|10|color=red:ma|main|20|color=green:ma|main|50|color=yellow:ma|main|100|color=white:');
        name=this.read('ind');
    }
...
function Config() {
   ...
   // console.log(""+DataReadervolumes.getYminmax);
    ...
    this.Global.DataAPIDB ="https://kdata.zhaobi.com:4062/kdata?datafile=" + __datafile__;
    if (__dbreset__) {
...
__symbol__list__ = {
   ...
   "BTYUSDT": { "time": ["M1", "M2", "M3", "M4", "M5", "M15", "M30", "H1", "H2", "H4", "D1", "W1", "MN1"], "yunit": 0.01 },
   "BTCUSDT": { "time": ["M1", "M2", "M3", "M4", "M5", "M15", "M30", "H1", "H2", "H4", "D1", "W1", "MN1"], "yunit": 0.01 },
   "BCCUSDT": { "time": ["M1", "M2", "M3", "M4", "M5", "M15", "M30", "H1", "H2", "H4", "D1", "W1", "MN1"], "yunit": 0.01 },
   "ETHUSDT": { "time": ["M1", "M2", "M3", "M4", "M5", "M15", "M30", "H1", "H2", "H4", "D1", "W1", "MN1"], "yunit": 0.01 },
   "ETCUSDT": { "time": ["M1", "M2", "M3", "M4", "M5", "M15", "M30", "H1", "H2", "H4", "D1", "W1", "MN1"], "yunit": 0.01 },
   "ZECUSDT": { "time": ["M1", "M2", "M3", "M4", "M5", "M15", "M30", "H1", "H2", "H4", "D1", "W1", "MN1"], "yunit": 0.01 },
   "LTCUSDT": { "time": ["M1", "M2", "M3", "M4", "M5", "M15", "M30", "H1", "H2", "H4", "D1", "W1", "MN1"], "yunit": 0.01 },
...
ToolBar.prototype.init = function() {
    ...
    $("#Indicator_list label").click(function () {
        var name=$(this).text();
        $.cookie('symbol',sessionStorage.getItem('period'));
    ...
    //  $("#btysymbol").click(function(){
    //     HTML5StockChartAPI.API.setPair("BTYUSDT", sessionStorage.getItem('period'));
    // })
    //  $("#btcsymbol").click(function(){
    //     HTML5StockChartAPI.API.setPair("BTCUSDT", sessionStorage.getItem('period'));
    // })
    //  $("#bccsymbol").click(function(){
    //     HTML5StockChartAPI.API.setPair("BCCUSDT",sessionStorage.getItem('period'));
    // })
...
ModelShort.prototype.getAPI = function() {
    ...
    if(sessionStorage.getItem('symbol')=="YCC"){
     ...
     return "https://kdata.zhaobi.com:4062/kdata?datafile=db" + "&c=NYCC&p="+ this.p;
    }
    else{
        return "https://kdata.zhaobi.com:4062/kdata?datafile=db" + "&c=" + sessionStorage.getItem('symbol') + "&p=" + this.p;
    }
    // if(this.p==null){
